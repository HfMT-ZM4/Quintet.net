...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 157.0, 211.0, 40.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 36.0, 40.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 314.0, 265.0, 81.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 111.0, 152.0, 22.0 ],
					"text" : "loadmess set Pointillize #1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 146.0, 99.0, 171.0, 20.0 ],
									"text" : "loadmess loadeffect Pointillize"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 249.0, 212.0, 39.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 111.0, 37.0, 38.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "center_y"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 213.0, 212.0, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 37.0, 40.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "center_x"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.0, 214.0, 71.0, 19.0 ],
					"text" : "pak param 0 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 213.0, 243.0, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 68.0, 39.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "radius"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 157.0, 243.0, 37.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 68.0, 37.0, 18.0 ],
					"style" : "comment_viewer_blue",
					"text" : "Radius"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 136.0, 379.0, 87.0, 19.0 ],
					"restore" : 					{
						"center_x" : [ 150.0 ],
						"center_y" : [ 150.0 ],
						"radius" : [ 20.0 ]
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 177.0, 176.0, 83.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 39.0, 1.0, 82.0, 20.0 ],
