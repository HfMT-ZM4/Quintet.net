...
, 			{
				"box" : 				{
					...
					"candicane4" : [ 0.533333, 0.533333, 0.533333, 1.0 ],
					"candycane" : 4,
					"contdata" : 1,
					"id" : "obj-24",
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 185.0, 286.0, 105.0, 32.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 112.0, 105.0, 32.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 4,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 296.0, 76.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 122.0, 75.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.0, 361.0, 103.0, 19.0 ],
					"text" : "pak param 4. 0. 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 259.0, 225.0, 32.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 126.0, 51.0, 31.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "Light_Points_At_z"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 217.0, 225.0, 31.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 94.0, 51.0, 30.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "Light_Points_At_y"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 222.0, 49.0, 29.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 0.0, 48.0, 49.0, 29.0 ],
					"style" : "comment_viewer_blue",
					"text" : "Light\nPoints At:"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 259.0, 198.0, 31.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.0, 24.0, 30.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 195.0, 45.0, 29.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 0.0, 21.0, 45.0, 29.0 ],
					"style" : "comment_viewer_blue",
					"text" : "Light \nPosition:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 307.0, 229.0, 91.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.0, 289.0, 71.0, 19.0 ],
					"text" : "pak param 2 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 321.0, 328.0, 73.0, 19.0 ],
					"text" : "pak param 3. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 217.0, 267.0, 31.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 80.0, 92.0, 30.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 266.0, 71.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 92.0, 71.0, 18.0 ],
					"style" : "comment_viewer_blue",
					"text" : "Concentration:"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 217.0, 247.0, 30.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.0, 73.0, 29.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "Brightness"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 248.0, 54.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 74.0, 54.0, 18.0 ],
					"style" : "comment_viewer_blue",
					"text" : "Brightness:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.0, 126.0, 155.0, 22.0 ],
					"text" : "loadmess set Spot Light #1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 146.0, 99.0, 183.0, 22.0 ],
									"text" : "loadmess loadeffect \"Spot Light\""
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 217.0, 198.0, 31.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 94.0, 24.0, 30.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"outputonclick" : 1,
					"parameter_enable" : 0,
					"patching_rect" : [ 182.0, 198.0, 31.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.0, 24.0, 30.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 260.0, 91.0, 19.0 ],
					"text" : "pak param 1 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 185.0, 225.0, 31.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.0, 51.0, 30.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "Light_Points_At_x"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 136.0, 379.0, 92.0, 19.0 ],
					"restore" : 					{
						"Brightness" : [ 3.0 ],
						"Concentration" : [ 0.1 ],
						...
						"Light_Position_x" : [ 400.0 ],
						"Light_Position_y" : [ 600.0 ],
						"Light_Position_z" : [ 150.0 ],
						"color" : [ 1.0, 1.0, 1.0, 1.0 ]
					}
,
					"text" : "autopattr Spot_Light",
					"varname" : "Spot_Light"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 41.0, 2.0, 83.0, 20.0 ],
