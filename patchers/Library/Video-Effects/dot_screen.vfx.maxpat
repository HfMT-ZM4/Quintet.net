...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.0, 296.0, 59.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 121.0, 59.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 266.0, 64.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.0, 235.0, 51.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.0, 204.0, 53.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 29.0, 52.0, 18.0 ],
					"style" : "comment_viewer_blue",
					"text" : "Center"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 327.0, 312.0, 71.0, 19.0 ],
					"text" : "pak param 2 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 344.0, 73.0, 19.0 ],
					"text" : "pak param 3. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 215.0, 295.0, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 77.0, 120.0, 39.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "sharpness"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 215.0, 265.0, 38.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.5, 111.0, 161.0, 22.0 ],
					"text" : "loadmess set Dot Screen #1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 146.0, 99.0, 189.0, 20.0 ],
									"text" : "loadmess loadeffect \"Dot Screen\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 86.0, 151.0, 147.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 255.0, 205.0, 39.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 117.0, 30.0, 38.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "center_y"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 215.0, 204.0, 39.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 77.0, 29.0, 38.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "center_x"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.0, 290.0, 71.0, 19.0 ],
					"text" : "pak param 1 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 215.0, 237.0, 40.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 78.0, 378.0, 96.0, 19.0 ],
					"restore" : 					{
						"angle" : [ 0.2 ],
						"center_x" : [ 150.0 ],
						"center_y" : [ 150.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.5, 176.0, 85.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 4.0, 84.0, 20.0 ],
