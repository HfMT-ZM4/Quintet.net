...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.0, 156.0, 64.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 91.0, 64.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.0, 115.5, 51.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 60.0, 51.0, 18.0 ],
					"style" : "comment_viewer_blue",
					"text" : "Angle"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 142.0, 155.0, 38.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 77.0, 90.0, 37.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "width"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 97.0, 28.0, 187.0, 22.0 ],
					"text" : "loadmess set Dot Screen (gl3) #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 429.0, 26.0, 83.0, 19.0 ],
					"text" : "loadmess #1 #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.0, 71.0, 125.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 210.0, 144.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 308.0, 139.0, 54.0, 19.0 ],
					"text" : "zl nth #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 308.0, 116.0, 47.0, 19.0 ],
					"text" : "route on"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.0, 95.0, 54.0, 19.0 ],
					"text" : "r #1chain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 284.0, 239.0, 47.0, 19.0 ],
					"text" : "forward"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.0, 132.0, 16.0, 19.0 ],
					"text" : "r"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 474.0, 178.554506497043974, 95.0, 22.0 ],
									"text" : "prepend iMouse"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 355.0, 192.054506497043974, 90.0, 22.0 ],
									"style" : "default",
									"text" : "prepend param"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 474.0, 84.158055041165937, 42.0, 22.0 ],
									"text" : "+ 3.14"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 474.0, 150.158055041165937, 47.0, 22.0 ],
									"text" : "pack f f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 474.0, 118.158055041165937, 74.0, 22.0 ],
									"text" : "divmod 3.14"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 474.0, 53.158055041165937, 309.0, 22.0 ],
									"restore" : [ 4.7 ],
...
,
									"text" : "pattr @bindto parent::angle @autorestore 0 @invisible 1",
									"varname" : "u337021634"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 355.0, 84.158055041165937, 85.0, 22.0 ],
									"style" : "default",
									"text" : "prepend iTime"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 309.0, 252.554506497043974, 398.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 355.0, 53.158055041165937, 117.0, 22.0 ],
									"style" : "default",
									"text" : "scale 0 10 3.14 4.71"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 355.0, 19.0, 307.0, 22.0 ],
									"restore" : [ 10.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
...
,
									"text" : "pattr @bindto parent::width @autorestore 0 @invisible 1",
									"varname" : "u560021638"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 264.0, 16.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 264.0, 44.0, 70.0, 22.0 ],
									"text" : "v resolution"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 187.0, 44.0, 68.0, 22.0 ],
									"text" : "r resolution"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 86.0, 134.0, 29.5, 19.0 ],
									"text" : "t b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 187.0, 87.158055041165937, 81.0, 22.0 ],
									"style" : "default",
									"text" : "prepend dim"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 86.0, 252.554506497043974, 125.0, 22.0 ],
									"style" : "default",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 85.0, 394.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 85.0, 294.0, 243.0, 22.0 ],
									"text" : "jit.gl.slab @file DotScreen.gl3.jxs"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 58.5, 358.0, 94.5, 358.0 ],
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 106.0, 165.5, 318.5, 165.5 ],
									"source" : [ "obj-4", 1 ]
								}
...
,
					"patching_rect" : [ 284.0, 183.0, 66.0, 19.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 143.0, 117.5, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 77.0, 62.0, 39.0, 20.0 ],
					"style" : "number_blue_n",
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "angle"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 66.0, 250.0, 96.0, 19.0 ],
					"restore" : 					{
						"angle" : [ 4.7 ],
						"width" : [ 10.0 ]
					}
,
					"text" : "autopattr Dot_Screen",
					"varname" : "Dot_Screen"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 97.0, 73.0, 105.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 438.5, 62.0, 293.5, 62.0 ],
					"order" : 1,
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 438.5, 204.0, 309.5, 204.0 ],
					"order" : 0,
					"source" : [ "obj-6", 0 ]
				}
