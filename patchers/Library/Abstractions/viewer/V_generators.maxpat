...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"id" : "obj-1",
					"items" : [ "camera", ",", "configs", ",", "desktop", ",", "gradient", ",", "jk-avatar", ",", "noise", ",", "notation", ",", "painter", ",", "spectrogram", ",", "syphon", ",", "vipr-receiver", ",", "waveform", ",", "radio-music", ",", "template" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
