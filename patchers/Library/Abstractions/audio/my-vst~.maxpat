...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"varname" : "wclose[1]",
					"text" : "script delete vst~, script newobject newobj @text vst~ @fontsize 9 @varname vst~ @patching_position 65 270 @fixwidth 0, script connect trigger 0 vst~ 0, script connect signal 0 vst~ 0, script connect pgm 1 vst~ 0, script connect vst~ 0 outlet0 0, script connect vst~ 1 outlet1 0, script connect vst~ 2 outlet2 0, script connect vst~ 3 outlet3 0, script connect vst~ 4 outlet4 0, script connect vst~ 5 prepend 0",
					"linecount" : 4,
					"numinlets" : 2,
					"fontsize" : 10.0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.0, 309.0, 78.0, 17.0 ],
					"id" : "obj-1",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 184.0, 15.0, 15.0 ],
					"id" : "obj-4",
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.0, 352.0, 15.0, 15.0 ],
					"id" : "obj-8",
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 352.0, 15.0, 15.0 ],
					"id" : "obj-9",
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.0, 352.0, 15.0, 15.0 ],
					"id" : "obj-10",
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 97.0, 352.0, 15.0, 15.0 ],
					"id" : "obj-11",
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.0, 17.0, 15.0, 15.0 ],
					"id" : "obj-13",
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 352.0, 15.0, 15.0 ],
					"id" : "obj-14",
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 65.0, 270.0, 100.0, 17.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 195.5, 294.0, 234.0, 294.0, 234.0, 339.0, 155.0, 339.0 ]
				}
