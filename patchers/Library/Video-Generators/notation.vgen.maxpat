...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"allowdrag" : 0,
					"id" : "obj-50",
					"items" : [ "loadScore", ",", "nextPage", ",", "previousPage", ",", "start", ",", "stop" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 423.125, 200.0, 94.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 28.0, 25.0, 105.0, 20.0 ],
					"style" : "umenu_brown",
					"varname" : "menu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 54.5, 265.0, 29.5, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 297.0, 136.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 323.0, 72.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 48.0, 150.0, 94.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 163.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 324.0, 100.0, 58.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.0, 136.0, 161.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 526.25, 199.0, 19.0, 22.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "newScore" ],
					"patching_rect" : [ 395.0, 252.0, 150.25, 20.0 ],
					"text" : "maxscore",
					"varname" : "MaxScore"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 297.5, 63.0, 19.0 ],
					"text" : "prepend dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.5, 233.0, 62.0, 19.0 ],
					"text" : "r resolution"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 203.0, 91.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 203.0, 127.5, 55.0, 19.0 ],
					"text" : "qmetro 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 658.333333333333371, 39.5, 91.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 37.5, 4.0, 85.0, 20.0 ],
					"style" : "comment_font_viewer-1",
					"text" : "Music Notation"
				}
