...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 638.0, 248.0, 243.0, 22.0 ],
					"text" : "pattrforward parent::parent::receiver::setport"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 638.0, 219.0, 59.0, 22.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"border" : 0.0,
					"bordercolor" : [ 0.349019607843137, 0.349019607843137, 0.349019607843137, 0.21 ],
					"id" : "obj-2",
					"keymode" : 1,
					"maxclass" : "textedit",
					"numinlets" : 1,
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 638.0, 182.0, 98.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 273.0, 110.0, 23.0 ],
					"rounded" : 0.0,
					"text" : "7999",
...
, 			{
				"box" : 				{
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"hint" : "To change Viewer attributes directly (bypassing the mapper) prepend /pattr to your OSC messages",
					"id" : "obj-1",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 638.0, 154.0, 92.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 273.0, 92.0, 20.0 ],
					"text" : "Port Number:",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 248.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 249.0, 92.0, 20.0 ],
					"text" : "Corner Pin:",
					"textcolor" : [ 0.866666666666667, 0.866666666666667, 0.901960784313726, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 224.0, 110.0, 22.0 ],
					"textcolor" : [ 0.121569, 0.121569, 0.121569, 1.0 ],
					"varname" : "changemode"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 225.0, 92.0, 20.0 ],
					"text" : "Preset System:",
					"textcolor" : [ 0.866666666666667, 0.866666666666667, 0.901960784313726, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 200.0, 110.0, 22.0 ],
					"textcolor" : [ 0.121569, 0.121569, 0.121569, 1.0 ],
					"varname" : "moviemenu"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 201.0, 117.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 126.0, 38.0, 22.0 ],
					"textcolor" : [ 0.866666666666667, 0.866666666666667, 0.901960784313726, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 125.0, 97.0, 20.0 ],
					"text" : "Chat Font Size:",
					"textcolor" : [ 0.866666666666667, 0.866666666666667, 0.901960784313726, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 101.0, 110.0, 22.0 ],
					"textcolor" : [ 0.121569, 0.121569, 0.121569, 1.0 ],
					"varname" : "chatfont"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 100.0, 97.0, 20.0 ],
					"text" : "Chat Font Type:",
					"textcolor" : [ 0.866666666666667, 0.866666666666667, 0.901960784313726, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 152.0, 43.0, 22.0 ],
					"textcolor" : [ 0.866666666666667, 0.866666666666667, 0.901960784313726, 1.0 ],
					"triangle" : 0,
					"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 176.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 177.0, 38.0, 22.0 ],
					"textcolor" : [ 0.866666666666667, 0.866666666666667, 0.901960784313726, 1.0 ],
					"triangle" : 0,
					"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 151.0, 84.0, 20.0 ],
					"text" : "Chat Opacity:",
					"textcolor" : [ 0.866666666666667, 0.866666666666667, 0.901960784313726, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 75.0, 110.0, 22.0 ],
					"textcolor" : [ 0.121569, 0.121569, 0.121569, 1.0 ],
					"varname" : "colormode"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 74.0, 77.0, 20.0 ],
					"text" : "Color Mode:",
					"textcolor" : [ 0.866666666666667, 0.866666666666667, 0.901960784313726, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 25.0, 111.0, 22.0 ],
					"textcolor" : [ 0.121569, 0.121569, 0.121569, 1.0 ],
					"varname" : "resolution"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 50.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 49.0, 81.0, 20.0 ],
					"text" : "Interpolation:",
					"textcolor" : [ 0.866666666666667, 0.866666666666667, 0.901960784313726, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 24.0, 72.0, 20.0 ],
					"text" : "Resolution:",
					"textcolor" : [ 0.866666666666667, 0.866666666666667, 0.901960784313726, 1.0 ]
				}
