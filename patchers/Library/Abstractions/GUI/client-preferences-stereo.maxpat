...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 600.0, 200.0, 620.0, 445.0 ],
					"varname" : "Mapper"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 600.0, 200.0, 221.0, 403.0 ],
					"varname" : "Project"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 662.0, 62.0, 44.0, 18.0 ],
					"text" : "Project"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 653.0, 0.0, 62.0, 76.0 ],
					"snap" : 1,
					"trackhorizontal" : 1,
					"tracking" : 1,
					"trackvertical" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1156.0, 76.0, 92.0, 14.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 1156.0, 53.0, 83.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 1156.0, 21.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 227.0, 435.0, 32.5, 16.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 226.5, 466.0, 72.0, 15.0 ],
									"text" : "window getsize"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 363.5, 414.0, 235.0, 14.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 227.0, 394.0, 32.5, 16.0 ],
									"text" : "+"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 227.0, 375.0, 36.0, 14.0 ],
									"text" : "$3 $5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 227.0, 414.0, 32.5, 16.0 ],
									"text" : "+ 80"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 200.0, 337.0, 32.5, 16.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.0, 357.0, 173.0, 14.0 ],
...
, 							{
								"box" : 								{
									"coll_data" : 									{
										...
										"data" : [ 											{
												"key" : "Inputs",
												"value" : [ 215, 137, 230, 450 ]
											}
, 											{
												"key" : "MIDI",
												"value" : [ 60, 108, 472, 350 ]
											}
, 											{
												"key" : "Plugins",
												"value" : [ 52, 116, 535, 298 ]
											}
, 											{
												"key" : "Sampler",
												"value" : [ 5, 80, 800, 574 ]
...
, 											{
												"key" : "Network",
												"value" : [ 105, 108, 452, 185 ]
											}
, 											{
												"key" : "Attributes",
												"value" : [ 115, 115, 459, 225 ]
											}
, 											{
												"key" : "Spatialization",
												"value" : [ 240, 110, 305, 450 ]
											}
, 											{
												"key" : "Video",
												"value" : [ 143, 112, 435, 430 ]
											}
, 											{
												"key" : "Mapper",
												"value" : [ 63, 97, 630, 380 ]
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 382.5, 437.0, 216.0, 14.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 200.0, 537.0, 25.0, 25.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 250.0, 460.0, 181.0, 460.0, 181.0, 183.0, 112.0, 183.0 ],
									"source" : [ "obj-60", 1 ]
								}
...
, 			{
				"box" : 				{
					...
					"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", 289, 44, 1028, 464, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
					"text" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ -41.0, -24.0 ],
					"patching_rect" : [ 115.0, 115.0, 522.0, 240.0 ],
					"varname" : "Attributes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 649.0, 0.0, 90.0, 76.0 ]
				}
